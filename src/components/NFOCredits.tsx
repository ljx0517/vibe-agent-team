...
import keygennMusic from "@/assets/nfo/vibe-agent-team-nfo.ogg";
...
export const NFOCredits: React.FC<NFOCreditsProps> = ({ onClose }) => {
  ...
  const creditsContent = [
    { type: "header", text: "Vibe Agent Team v0.2.1" },
            ...
            <div className="flex items-center justify-between px-4 py-2 bg-card border-b border-border">
              ...
              <div className="flex items-center space-x-2">
                <Button
                  ...
                  onClick={async (e) => {
                    e.stopPropagation();
                    await openUrl("https://github.com/ljx0517/vibe-agent-team/issues/new");
                  }}
