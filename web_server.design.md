# Vibe Agent Team Web Server Design

This document describes the implementation of Vibe Agent Team's web server mode, which allows access to Claude Code from mobile devices and browsers while maintaining full functionality.
