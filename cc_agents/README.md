# 🤖 Vibe Agent Team CC Agents

<div align="center">
  <p>
    <strong>Pre-built AI agents for Vibe Agent Team powered by Claude Code</strong>
  </p>
  <p>
...
1. In Vibe Agent Team, navigate to **CC Agents**
...
1. Download a `.vibe-agent-team-agents.json` file from this repository
2. In Vibe Agent Team, navigate to **CC Agents**
3. Click the **Import** dropdown button
4. Select **From File**
5. Choose the downloaded `.vibe-agent-team-agents.json` file
...
4. Choose where to save the `.vibe-agent-team-agents.json` file

### Agent File Format

All agents are stored in `.vibe-agent-team-agents.json` format with the following structure:
...
### 1. Create Your Agent
Design and test your agent in Vibe Agent Team with a clear, focused purpose.

### 2. Export Your Agent
Export your agent to a `.vibe-agent-team-agents.json` file with a descriptive name.

### 3. Submit a Pull Request
1. Fork this repository
2. Add your `.vibe-agent-team-agents.json` file to the `cc_agents` directory
...
These agents are provided under the same license as the Vibe Agent Team project. See the main LICENSE file for details.

---

<div align="center">
  <strong>Built with ❤️ by the Vibe Agent Team community</strong>
</div> 
